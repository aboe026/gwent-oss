...
import { PlayerRound, RoundResult, Unit, User } from '@gwent-oss/graphql-schema/resolver-typings'
import { PlayerRoundDbObject } from '@gwent-oss/graphql-schema/database-typings'
