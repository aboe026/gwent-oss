...
import * as discardRoundUnits from '../../src/graphql/resolvers/mutations/play-pass/discard-round-units'
...
async function testPlayPassImplementation({
  ...
  const discardRoundUnitsSpy = jest.spyOn(discardRoundUnits, 'default').mockImplementation()
