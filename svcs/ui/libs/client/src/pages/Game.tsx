...
import { getApolloError, retryCheckingAuth } from '../util/error-util.mjs'
...
import UnitFullCard from '../components/UnitFullCard.jsx'
import UnitGameCard from '../components/UnitGameCard.jsx'
      ...
      if (data?.addGame) {
        ...
        if (previousGames?.games) {
          cache.writeQuery({
            query: GamesDocument,
            data: {
              games: [...(previousGames?.games || []), data.addGame],
            },
          })
        }
        cache.writeQuery({
