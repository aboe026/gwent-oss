...
import BasicAuth from './auth/basic-auth.mjs'
import DbConnector from './database/db-connector.mjs'
import DbUpgrader from './database/db-upgrader.mjs'
import env from './env.mjs'
import { NODE_ENV } from '@gwent/env'
import schema from './graphql/executable-schema.mjs'
...
export default class Api {
  ...
  private static async printStartupInfo() {
    ...
    Api.logger.info(`Version: "${packageJson.version}"`)
