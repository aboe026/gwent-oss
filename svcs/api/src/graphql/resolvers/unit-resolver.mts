...
import DlcStore from '../../database/stores/dlc-store.mjs'
import EffectResolver from './effect-resolver.mjs'
import EffectStore from '../../database/stores/effect-store.mjs'
...
import { prettyPrintList } from '../../util/string-util.mjs'
...
export default class UnitResolver {
  private static logger = log4js.getLogger('unit-resolver')
