...
import dlcs from './resources/dlcs.json' assert { type: 'json' }
import DlcStore, { AddDlcInput } from '../stores/dlc-store.mjs'
import effects from './resources/effects.json' assert { type: 'json' }
import EffectStore, { AddEffectInput } from '../stores/effect-store.mjs'
import factions from './resources/factions.json' assert { type: 'json' }
import FactionStore, { AddFactionInput } from '../stores/faction-store.mjs'
import { getDeckStats } from '@gwent/utils'
import leaders from './resources/leaders.json' assert { type: 'json' }
import LeaderStore, { AddLeaderInput } from '../stores/leader-store.mjs'
import units from './resources/units.json' assert { type: 'json' }
import UnitStore, { AddUnitInput } from '../stores/unit-store.mjs'
