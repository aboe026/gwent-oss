...
import allUpgrades from './upgrades/all-upgrades.mjs'
import { sleep } from '@gwent/utils'
import Upgrade from './upgrades/upgrade.mjs'
import UpgradeStore from './stores/upgrade-store.mjs'
...
export default class DbUpgrader {
  ...
  private static logger = log4js.getLogger('upgrader')
