...
export type GameReadySubscription = { __typename?: 'Subscription', gameReady: { __typename?: 'Game', id: string, status: GameStatus, players: Array<{ __typename?: 'GamePlayer', ready: boolean, user: { __typename?: 'User', name: string } }> } };
