...
import { FactionKey, Game, User } from '@gwent-oss/node-client'
import GamePage, { HistoryMove } from '../page-objects/game-page'
...
fixture("Game Faction Scoia'tael Ability")
